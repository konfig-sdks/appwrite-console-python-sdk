...
class RequiredUsersCreateMessagingTargetRequest(TypedDict):
...
class OptionalUsersCreateMessagingTargetRequest(TypedDict, total=False):
...
class UsersCreateMessagingTargetRequest(RequiredUsersCreateMessagingTargetRequest, OptionalUsersCreateMessagingTargetRequest):
    pass
