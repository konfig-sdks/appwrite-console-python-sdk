...
class RequiredMessagingUpdateSmtpProviderRequest(TypedDict):
    pass

class OptionalMessagingUpdateSmtpProviderRequest(TypedDict, total=False):
    # Provider name.
    name: str
...
class MessagingUpdateSmtpProviderRequest(RequiredMessagingUpdateSmtpProviderRequest, OptionalMessagingUpdateSmtpProviderRequest):
    pass
