...
class RequiredAccountCreatePushTargetRequest(TypedDict):
...
class OptionalAccountCreatePushTargetRequest(TypedDict, total=False):
...
class AccountCreatePushTargetRequest(RequiredAccountCreatePushTargetRequest, OptionalAccountCreatePushTargetRequest):
    pass
