...
class RequiredFunctionsCreateDeploymentRequest(TypedDict):
...
class OptionalFunctionsCreateDeploymentRequest(TypedDict, total=False):
    # Entrypoint File.
    entrypoint: str
...
class FunctionsCreateDeploymentRequest(RequiredFunctionsCreateDeploymentRequest, OptionalFunctionsCreateDeploymentRequest):
    pass
