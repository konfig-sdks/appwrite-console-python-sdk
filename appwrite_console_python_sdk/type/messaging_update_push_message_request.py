...
class RequiredMessagingUpdatePushMessageRequest(TypedDict):
    pass

class OptionalMessagingUpdatePushMessageRequest(TypedDict, total=False):
    # Title for push notification.
    title: str

    topics: MessagingUpdatePushMessageRequestTopics

    users: MessagingUpdatePushMessageRequestUsers

    targets: MessagingUpdatePushMessageRequestTargets
...
class MessagingUpdatePushMessageRequest(RequiredMessagingUpdatePushMessageRequest, OptionalMessagingUpdatePushMessageRequest):
    pass
