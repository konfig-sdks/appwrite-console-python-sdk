...
class RequiredMessagingCreateMailgunProviderRequest(TypedDict):
...
class OptionalMessagingCreateMailgunProviderRequest(TypedDict, total=False):
    # Mailgun API Key.
    apiKey: str
...
class MessagingCreateMailgunProviderRequest(RequiredMessagingCreateMailgunProviderRequest, OptionalMessagingCreateMailgunProviderRequest):
    pass
