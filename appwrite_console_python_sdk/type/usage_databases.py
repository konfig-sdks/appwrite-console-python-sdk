...
class RequiredUsageDatabases(TypedDict):
    ...
    databases: typing.List[Metric]

    # Aggregated number of collections per period.
    collections: typing.List[Metric]

    # Aggregated number of documents per period.
    documents: typing.List[Metric]

class OptionalUsageDatabases(TypedDict, total=False):
    pass

class UsageDatabases(RequiredUsageDatabases, OptionalUsageDatabases):
    pass
