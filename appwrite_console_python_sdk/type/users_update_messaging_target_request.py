...
class RequiredUsersUpdateMessagingTargetRequest(TypedDict):
    pass

class OptionalUsersUpdateMessagingTargetRequest(TypedDict, total=False):
...
class UsersUpdateMessagingTargetRequest(RequiredUsersUpdateMessagingTargetRequest, OptionalUsersUpdateMessagingTargetRequest):
    pass
