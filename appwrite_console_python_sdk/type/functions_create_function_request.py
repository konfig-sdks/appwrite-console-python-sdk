...
class RequiredFunctionsCreateFunctionRequest(TypedDict):
...
class OptionalFunctionsCreateFunctionRequest(TypedDict, total=False):
    execute: FunctionsCreateFunctionRequestExecute

    events: FunctionsCreateFunctionRequestEvents
...
class FunctionsCreateFunctionRequest(RequiredFunctionsCreateFunctionRequest, OptionalFunctionsCreateFunctionRequest):
    pass
