...
class DatabasesCreateFloatAttributeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "required", "min", "max", "default", "array", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "required", "min", "max", "default", "array", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        default: typing.Union[MetaOapg.properties.default, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
