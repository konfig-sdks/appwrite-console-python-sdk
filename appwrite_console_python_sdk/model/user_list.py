...
class UserList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "users", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "users", ], str]):
