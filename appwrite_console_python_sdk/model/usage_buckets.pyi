...
class UsageBuckets(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["range", "filesTotal", "filesStorageTotal", "files", "storage", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["range", "filesTotal", "filesStorageTotal", "files", "storage", ], str]):
