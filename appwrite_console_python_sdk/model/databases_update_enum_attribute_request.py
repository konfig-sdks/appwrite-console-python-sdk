...
class DatabasesUpdateEnumAttributeRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def elements() -> typing.Type['DatabasesUpdateEnumAttributeRequestElements']:
                return DatabasesUpdateEnumAttributeRequestElements
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["elements"]) -> 'DatabasesUpdateEnumAttributeRequestElements': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["elements", "required", "default", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["elements"]) -> 'DatabasesUpdateEnumAttributeRequestElements': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["elements", "required", "default", ], str]):
