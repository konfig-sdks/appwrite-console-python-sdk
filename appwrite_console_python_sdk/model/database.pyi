...
class Database(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["$id", "name", "$createdAt", "$updatedAt", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["$id", "name", "$createdAt", "$updatedAt", "enabled", ], str]):
