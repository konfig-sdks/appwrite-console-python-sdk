...
class FirebaseProjectList(
        ...
        class properties:
            ...
            class projects(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirebaseProject']:
                        return FirebaseProject
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['FirebaseProject'], typing.List['FirebaseProject']],
                ...
                def __getitem__(self, i: int) -> 'FirebaseProject':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "projects", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "projects", ], str]):
