...
class MessageList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "messages", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "messages", ], str]):
