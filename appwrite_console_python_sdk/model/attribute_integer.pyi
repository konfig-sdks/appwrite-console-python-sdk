...
class AttributeInteger(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "type", "status", "error", "required", "array", "min", "max", "default", "example", "x-konfig-original-example", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "type", "status", "error", "required", "array", "min", "max", "default", "example", "x-konfig-original-example", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        min: typing.Union[MetaOapg.properties.min, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        max: typing.Union[MetaOapg.properties.max, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        default: typing.Union[MetaOapg.properties.default, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        example: typing.Union[MetaOapg.properties.example, None, decimal.Decimal, int, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
