...
class MessagingCreateTelesignProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "from", "customerId", "apiKey", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "from", "customerId", "apiKey", "enabled", ], str]):
