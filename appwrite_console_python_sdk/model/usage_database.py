...
class UsageDatabase(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["range", "collectionsTotal", "documentsTotal", "collections", "documents", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["range", "collectionsTotal", "documentsTotal", "collections", "documents", ], str]):
