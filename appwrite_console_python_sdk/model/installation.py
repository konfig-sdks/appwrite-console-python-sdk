...
class Installation(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            providerInstallationId = schemas.StrSchema
            __annotations__ = {
                "$id": id,
    ...
    providerInstallationId: MetaOapg.properties.providerInstallationId
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["providerInstallationId"]) -> MetaOapg.properties.providerInstallationId: ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["$id", "$createdAt", "$updatedAt", "provider", "organization", "providerInstallationId", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["providerInstallationId"]) -> MetaOapg.properties.providerInstallationId: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["$id", "$createdAt", "$updatedAt", "provider", "organization", "providerInstallationId", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        providerInstallationId: typing.Union[MetaOapg.properties.providerInstallationId, str, ],
