...
class FunctionList(
        ...
        class properties:
            ...
            class functions(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Function']:
                        return Function
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Function'], typing.List['Function']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "functions", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "functions", ], str]):
