...
class MessagingUpdateVonageProviderByIdRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "apiKey", "apiSecret", "from", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "apiKey", "apiSecret", "from", ], str]):
