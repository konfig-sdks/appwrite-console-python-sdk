...
class MessagingUpdateSendgridProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "apiKey", "fromName", "fromEmail", "replyToName", "replyToEmail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "apiKey", "fromName", "fromEmail", "replyToName", "replyToEmail", ], str]):
