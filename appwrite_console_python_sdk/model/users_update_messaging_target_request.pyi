...
class UsersUpdateMessagingTargetRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["identifier", "providerId", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["identifier", "providerId", "name", ], str]):
