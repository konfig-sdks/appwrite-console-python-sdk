...
class UsageCollection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["range", "documentsTotal", "documents", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["range", "documentsTotal", "documents", ], str]):
