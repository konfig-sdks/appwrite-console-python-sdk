...
class MessagingCreateSmtpProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "host", "port", "username", "password", "encryption", "autoTLS", "mailer", "fromName", "fromEmail", "replyToName", "replyToEmail", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "host", "port", "username", "password", "encryption", "autoTLS", "mailer", "fromName", "fromEmail", "replyToName", "replyToEmail", "enabled", ], str]):
