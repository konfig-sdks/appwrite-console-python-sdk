...
class PlatformList(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "platforms", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "platforms", ], str]):
