...
class DatabasesCreateDatetimeAttributeRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "required", "default", "array", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "required", "default", "array", ], str]):
