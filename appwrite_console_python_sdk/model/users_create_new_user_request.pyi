...
class UsersCreateNewUserRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userId", "email", "phone", "password", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userId", "email", "phone", "password", "name", ], str]):
