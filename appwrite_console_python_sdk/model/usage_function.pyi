...
class UsageFunction(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["range", "deploymentsTotal", "deploymentsStorageTotal", "buildsTotal", "buildsStorageTotal", "buildsTimeTotal", "executionsTotal", "executionsTimeTotal", "deployments", "deploymentsStorage", "builds", "buildsStorage", "buildsTime", "executions", "executionsTime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["range", "deploymentsTotal", "deploymentsStorageTotal", "buildsTotal", "buildsStorageTotal", "buildsTimeTotal", "executionsTotal", "executionsTimeTotal", "deployments", "deploymentsStorage", "builds", "buildsStorage", "buildsTime", "executions", "executionsTime", ], str]):
