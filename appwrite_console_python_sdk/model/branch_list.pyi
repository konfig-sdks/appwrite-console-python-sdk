...
class BranchList(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class branches(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Branch'], typing.List['Branch']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "branches", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "branches", ], str]):
