...
class DatabasesCreateEnumAttributeRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def elements() -> typing.Type['DatabasesCreateEnumAttributeRequestElements']:
                return DatabasesCreateEnumAttributeRequestElements
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["elements"]) -> 'DatabasesCreateEnumAttributeRequestElements': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "elements", "required", "default", "array", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["elements"]) -> 'DatabasesCreateEnumAttributeRequestElements': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "elements", "required", "default", "array", ], str]):
