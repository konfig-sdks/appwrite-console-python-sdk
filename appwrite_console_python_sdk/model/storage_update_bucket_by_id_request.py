...
class StorageUpdateBucketByIdRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def permissions() -> typing.Type['StorageUpdateBucketByIdRequestPermissions']:
                return StorageUpdateBucketByIdRequestPermissions
            fileSecurity = schemas.BoolSchema
            enabled = schemas.BoolSchema
            maximumFileSize = schemas.IntSchema
        
            @staticmethod
            def allowedFileExtensions() -> typing.Type['StorageUpdateBucketByIdRequestAllowedFileExtensions']:
                return StorageUpdateBucketByIdRequestAllowedFileExtensions
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["permissions"]) -> 'StorageUpdateBucketByIdRequestPermissions': ...
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["allowedFileExtensions"]) -> 'StorageUpdateBucketByIdRequestAllowedFileExtensions': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "permissions", "fileSecurity", "enabled", "maximumFileSize", "allowedFileExtensions", "compression", "encryption", "antivirus", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["permissions"]) -> typing.Union['StorageUpdateBucketByIdRequestPermissions', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["allowedFileExtensions"]) -> typing.Union['StorageUpdateBucketByIdRequestAllowedFileExtensions', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "permissions", "fileSecurity", "enabled", "maximumFileSize", "allowedFileExtensions", "compression", "encryption", "antivirus", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        permissions: typing.Union['StorageUpdateBucketByIdRequestPermissions', schemas.Unset] = schemas.unset,
        ...
        allowedFileExtensions: typing.Union['StorageUpdateBucketByIdRequestAllowedFileExtensions', schemas.Unset] = schemas.unset,
