...
class MessagingCreateSendgridProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "apiKey", "fromName", "fromEmail", "replyToName", "replyToEmail", "enabled", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "apiKey", "fromName", "fromEmail", "replyToName", "replyToEmail", "enabled", ], str]):
