...
class DeploymentList(
        ...
        class properties:
            ...
            class deployments(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['Deployment']:
                        return Deployment
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Deployment'], typing.List['Deployment']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "deployments", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "deployments", ], str]):
