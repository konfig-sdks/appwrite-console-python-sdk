...
class ProjectsUpdateCustomEmailTemplatesRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subject", "message", "senderName", "senderEmail", "replyTo", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subject", "message", "senderName", "senderEmail", "replyTo", ], str]):
