...
class CollectionList(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class collections(
                ...
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['Collection'], typing.List['Collection']],
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "collections", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "collections", ], str]):
