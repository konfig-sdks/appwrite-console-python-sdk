...
class ProjectsUpdatePlatformByIdRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "key", "store", "hostname", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "key", "store", "hostname", ], str]):
