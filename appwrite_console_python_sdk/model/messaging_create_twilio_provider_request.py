...
class MessagingCreateTwilioProviderRequest(
    schemas.DictSchema
):
    """
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["accountSid"]) -> MetaOapg.properties.accountSid: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "from", "accountSid", "authToken", "enabled", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["accountSid"]) -> typing.Union[MetaOapg.properties.accountSid, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["providerId", "name", "from", "accountSid", "authToken", "enabled", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        accountSid: typing.Union[MetaOapg.properties.accountSid, str, schemas.Unset] = schemas.unset,
