...
class MetricBreakdown(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["resourceId", "name", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["resourceId", "name", "value", ], str]):
