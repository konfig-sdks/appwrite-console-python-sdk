...
class TeamsCreateTeamRequest(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def roles() -> typing.Type['TeamsCreateTeamRequestRoles']:
                return TeamsCreateTeamRequestRoles
            __annotations__ = {
                "teamId": teamId,
                "name": name,
                "roles": roles,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["roles"]) -> 'TeamsCreateTeamRequestRoles': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["roles"]) -> typing.Union['TeamsCreateTeamRequestRoles', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        roles: typing.Union['TeamsCreateTeamRequestRoles', schemas.Unset] = schemas.unset,
