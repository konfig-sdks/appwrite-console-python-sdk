...
class MessagingUpdateMailgunProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "apiKey", "domain", "isEuRegion", "enabled", "fromName", "fromEmail", "replyToName", "replyToEmail", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "apiKey", "domain", "isEuRegion", "enabled", "fromName", "fromEmail", "replyToName", "replyToEmail", ], str]):
