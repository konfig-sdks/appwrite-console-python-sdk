...
class AttributeString(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["key", "type", "status", "error", "required", "size", "array", "default", "example", "x-konfig-original-example", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["key", "type", "status", "error", "required", "size", "array", "default", "example", "x-konfig-original-example", ], str]):
