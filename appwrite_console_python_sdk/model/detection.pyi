...
class Detection(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["runtime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["runtime", ], str]):
