...
class MessagingUpdateTelesignProviderRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "customerId", "apiKey", "from", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "enabled", "customerId", "apiKey", "from", ], str]):
