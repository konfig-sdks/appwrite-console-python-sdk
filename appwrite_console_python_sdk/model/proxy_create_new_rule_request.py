...
class ProxyCreateNewRuleRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["domain", "resourceType", "resourceId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["domain", "resourceType", "resourceId", ], str]):
