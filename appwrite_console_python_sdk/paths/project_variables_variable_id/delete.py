...
class BaseApi(api_client.Api):
    ...
    def _delete_variable_by_id_mapped_args(
        self,
        variable_id: str,
    ...
    async def _adelete_variable_by_id_oapg(
        self,
    ...
    def _delete_variable_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteVariableByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_variable_by_id(
        self,
        variable_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_variable_by_id_mapped_args(
            variable_id=variable_id,
        )
        return await self._adelete_variable_by_id_oapg(
    ...
    def delete_variable_by_id(
        ...
        return self._delete_variable_by_id_oapg(
            path_params=args.path,
        )

class DeleteVariableById(BaseApi):
    ...
    async def adelete_variable_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_variable_by_id(
            variable_id=variable_id,
            **kwargs,
        )
    ...
    def delete_variable_by_id(
        ...
        raw_response = self.raw.delete_variable_by_id(
            variable_id=variable_id,
        )
