...
class BaseApi(api_client.Api):
    ...
    def _variable_details_mapped_args(
        self,
        variable_id: str,
    ...
    async def _avariable_details_oapg(
        self,
...
class VariableDetailsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def avariable_details(
        self,
        variable_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._variable_details_mapped_args(
            variable_id=variable_id,
        )
        return await self._avariable_details_oapg(
    ...
    def variable_details(
        ...
        return self._variable_details_oapg(
            path_params=args.path,
        )

class VariableDetails(BaseApi):
    ...
    async def avariable_details(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.avariable_details(
            variable_id=variable_id,
            **kwargs,
        )
        if validate:
    ...
    def variable_details(
        ...
        raw_response = self.raw.variable_details(
            variable_id=variable_id,
        )
        if validate:
            return VariablePydantic(**raw_response.body)
