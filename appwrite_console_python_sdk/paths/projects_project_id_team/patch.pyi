...
from appwrite_console_python_sdk.model.projects_update_team_request import ProjectsUpdateTeamRequest as ProjectsUpdateTeamRequestSchema

from appwrite_console_python_sdk.type.projects_update_team_request import ProjectsUpdateTeamRequest
...
from appwrite_console_python_sdk.pydantic.projects_update_team_request import ProjectsUpdateTeamRequest as ProjectsUpdateTeamRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsUpdateTeamRequestSchema


request_body_projects_update_team_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_team_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/projects/{projectId}/team',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_projects_update_team_request.serialize(body, content_type)
