...
class BaseApi(api_client.Api):
    ...
    def _get_message_by_id_mapped_args(
        self,
        message_id: str,
    ...
    async def _aget_message_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/messaging/messages/{messageId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMessageByIdRaw(BaseApi):
    ...
    async def aget_message_by_id(
        ...
        **kwargs,
        ...
        args = self._get_message_by_id_mapped_args(
            message_id=message_id,
        )
        return await self._aget_message_by_id_oapg(
    ...
    def get_message_by_id(
        ...
        return self._get_message_by_id_oapg(
            path_params=args.path,
        )

class GetMessageById(BaseApi):
    ...
    async def aget_message_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_message_by_id(
            message_id=message_id,
            **kwargs,
        )
        if validate:
    ...
    def get_message_by_id(
        ...
        raw_response = self.raw.get_message_by_id(
            message_id=message_id,
        )
        if validate:
            return MessagePydantic(**raw_response.body)
