...
class BaseApi(api_client.Api):
    ...
    def _logout_session_mapped_args(
        self,
        session_id: str,
    ...
    async def _alogout_session_oapg(
        self,
...
class LogoutSessionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alogout_session(
        self,
        session_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._logout_session_mapped_args(
            session_id=session_id,
        )
        return await self._alogout_session_oapg(
    ...
    def logout_session(
        ...
        return self._logout_session_oapg(
            path_params=args.path,
        )

class LogoutSession(BaseApi):
    ...
    async def alogout_session(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alogout_session(
            session_id=session_id,
            **kwargs,
        )
    ...
    def logout_session(
        ...
        raw_response = self.raw.logout_session(
            session_id=session_id,
        )
