...
class NameSchema(
    ...
    class MetaOapg:
        enum_value_to_name = {
            "v1-database": "V1DATABASE",
            "v1-deletes": "V1DELETES",
            "v1-audits": "V1AUDITS",
            "v1-mails": "V1MAILS",
            "v1-functions": "V1FUNCTIONS",
            "v1-usage": "V1USAGE",
            "v1-usage-dump": "V1USAGEDUMP",
            "webhooksv1": "WEBHOOKSV1",
            "v1-certificates": "V1CERTIFICATES",
            "v1-builds": "V1BUILDS",
            "v1-messaging": "V1MESSAGING",
            "v1-migrations": "V1MIGRATIONS",
            "hamsterv1": "HAMSTERV1",
        }
