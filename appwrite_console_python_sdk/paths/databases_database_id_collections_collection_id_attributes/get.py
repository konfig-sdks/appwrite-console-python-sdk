...
from appwrite_console_python_sdk.model.attribute_list import AttributeList as AttributeListSchema

from appwrite_console_python_sdk.type.attribute_list import AttributeList

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.attribute_list import AttributeList as AttributeListPydantic
...
SchemaFor200ResponseBodyApplicationJson = AttributeListSchema
    ...
    async def _alist_attributes_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/databases/{databaseId}/collections/{collectionId}/attributes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListAttributes(BaseApi):
    ...
    async def alist_attributes(
        ...
        **kwargs,
        ...
        if validate:
            return AttributeListPydantic(**raw_response.body)
        return api_client.construct_model_instance(AttributeListPydantic, raw_response.body)
