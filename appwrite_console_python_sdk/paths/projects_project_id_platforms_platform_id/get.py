...
class BaseApi(api_client.Api):
    ...
    def _get_platform_by_id_mapped_args(
        self,
        project_id: str,
        platform_id: str,
    ...
    async def _aget_platform_by_id_oapg(
        self,
...
class GetPlatformByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_platform_by_id(
        self,
        project_id: str,
        platform_id: str,
        **kwargs,
        ...
        args = self._get_platform_by_id_mapped_args(
            project_id=project_id,
            platform_id=platform_id,
        )
        return await self._aget_platform_by_id_oapg(
    ...
    def get_platform_by_id(
        ...
        return self._get_platform_by_id_oapg(
            path_params=args.path,
        )

class GetPlatformById(BaseApi):
    ...
    async def aget_platform_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_platform_by_id(
            project_id=project_id,
            platform_id=platform_id,
            **kwargs,
        )
    ...
    def get_platform_by_id(
        ...
        raw_response = self.raw.get_platform_by_id(
            project_id=project_id,
            platform_id=platform_id,
        )
        if validate:
