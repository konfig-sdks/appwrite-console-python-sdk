...
class BaseApi(api_client.Api):
    ...
    def _get_mails_queue_mapped_args(
        self,
    ...
    async def _aget_mails_queue_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/health/queue/mails',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetMailsQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_mails_queue(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_mails_queue_mapped_args(
            threshold=threshold,
        )
        return await self._aget_mails_queue_oapg(
    ...
    def get_mails_queue(
        ...
        return self._get_mails_queue_oapg(
            query_params=args.query,
        )

class GetMailsQueue(BaseApi):
    ...
    async def aget_mails_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_mails_queue(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_mails_queue(
        ...
        raw_response = self.raw.get_mails_queue(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
