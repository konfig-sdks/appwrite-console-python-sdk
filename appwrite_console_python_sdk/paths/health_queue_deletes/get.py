...
class BaseApi(api_client.Api):
    ...
    def _get_queue_deletes_mapped_args(
        self,
    ...
    async def _aget_queue_deletes_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/health/queue/deletes',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetQueueDeletesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_queue_deletes(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_queue_deletes_mapped_args(
            threshold=threshold,
        )
        return await self._aget_queue_deletes_oapg(
    ...
    def get_queue_deletes(
        ...
        return self._get_queue_deletes_oapg(
            query_params=args.query,
        )

class GetQueueDeletes(BaseApi):
    ...
    async def aget_queue_deletes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_queue_deletes(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_queue_deletes(
        ...
        raw_response = self.raw.get_queue_deletes(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
