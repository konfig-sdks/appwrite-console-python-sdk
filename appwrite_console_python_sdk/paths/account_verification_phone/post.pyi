...
class BaseApi(api_client.Api):
    ...
    def _send_verification_sms_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _asend_verification_sms_oapg(
        self,
    ...
    def _send_verification_sms_oapg(
        self,
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
...
class SendVerificationSmsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def asend_verification_sms(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor201Async,
        ...
        args = self._send_verification_sms_mapped_args(
        )
        return await self._asend_verification_sms_oapg(
            **kwargs,
        )
    ...
    def send_verification_sms(
        ...
        return self._send_verification_sms_oapg(
        )

class SendVerificationSms(BaseApi):
    ...
    async def asend_verification_sms(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.asend_verification_sms(
            **kwargs,
        )
        if validate:
    ...
    def send_verification_sms(
        ...
        raw_response = self.raw.send_verification_sms(
        )
        if validate:
            return TokenPydantic(**raw_response.body)
        return api_client.construct_model_instance(TokenPydantic, raw_response.body)
