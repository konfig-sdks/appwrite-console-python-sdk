...
class BaseApi(api_client.Api):
    ...
    def _get_databases_queue_mapped_args(
        self,
    ...
    async def _aget_databases_queue_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/health/queue/databases',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDatabasesQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_databases_queue(
        self,
        name: typing.Optional[str] = None,
        threshold: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_databases_queue_mapped_args(
            name=name,
            threshold=threshold,
        )
        return await self._aget_databases_queue_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_databases_queue(
        self,
        name: typing.Optional[str] = None,
        threshold: typing.Optional[int] = None,
    ) -> typing.Union[
        ...
        return self._get_databases_queue_oapg(
            query_params=args.query,
        )

class GetDatabasesQueue(BaseApi):
    ...
    async def aget_databases_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_databases_queue(
            name=name,
            threshold=threshold,
            **kwargs,
        )
    ...
    def get_databases_queue(
        ...
        raw_response = self.raw.get_databases_queue(
            name=name,
            threshold=threshold,
        )
        if validate:
