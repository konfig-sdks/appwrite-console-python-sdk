...
from appwrite_console_python_sdk.model.users_update_email_by_id_request import UsersUpdateEmailByIdRequest as UsersUpdateEmailByIdRequestSchema
...
from appwrite_console_python_sdk.type.users_update_email_by_id_request import UsersUpdateEmailByIdRequest

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.user import User as UserPydantic
from appwrite_console_python_sdk.pydantic.users_update_email_by_id_request import UsersUpdateEmailByIdRequest as UsersUpdateEmailByIdRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = UsersUpdateEmailByIdRequestSchema


request_body_users_update_email_by_id_request = api_client.RequestBody(
    content={
    ...
    async def _aupdate_email_by_id_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/users/{userId}/email',
            body=body,
            auth_settings=_auth,
            headers=_headers,
        )
        if body is not schemas.unset:
            serialized_data = request_body_users_update_email_by_id_request.serialize(body, content_type)
