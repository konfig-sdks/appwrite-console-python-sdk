...
class BaseApi(api_client.Api):
    ...
    def _delete_collection_by_id_mapped_args(
        self,
        database_id: str,
        collection_id: str,
    ...
    async def _adelete_collection_by_id_oapg(
        self,
    ...
    def _delete_collection_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteCollectionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_collection_by_id(
        self,
        database_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._delete_collection_by_id_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
        )
        return await self._adelete_collection_by_id_oapg(
    ...
    def delete_collection_by_id(
        ...
        return self._delete_collection_by_id_oapg(
            path_params=args.path,
        )

class DeleteCollectionById(BaseApi):
    ...
    async def adelete_collection_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_collection_by_id(
            database_id=database_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def delete_collection_by_id(
        ...
        raw_response = self.raw.delete_collection_by_id(
            database_id=database_id,
            collection_id=collection_id,
        )
