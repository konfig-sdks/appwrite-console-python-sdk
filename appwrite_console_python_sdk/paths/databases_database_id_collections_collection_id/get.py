...
class BaseApi(api_client.Api):
    ...
    def _get_collection_by_id_mapped_args(
        self,
        database_id: str,
        collection_id: str,
    ...
    async def _aget_collection_by_id_oapg(
        self,
...
class GetCollectionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_collection_by_id(
        self,
        database_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._get_collection_by_id_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
        )
        return await self._aget_collection_by_id_oapg(
...
class GetCollectionById(BaseApi):
    ...
    async def aget_collection_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_collection_by_id(
            database_id=database_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def get_collection_by_id(
        ...
        raw_response = self.raw.get_collection_by_id(
            database_id=database_id,
            collection_id=collection_id,
        )
        if validate:
