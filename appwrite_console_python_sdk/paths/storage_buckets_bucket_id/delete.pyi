...
class BaseApi(api_client.Api):
    ...
    def _delete_bucket_by_id_mapped_args(
        self,
        bucket_id: str,
    ...
    async def _adelete_bucket_by_id_oapg(
        self,
...
class DeleteBucketByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_bucket_by_id(
        self,
        bucket_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_bucket_by_id_mapped_args(
            bucket_id=bucket_id,
        )
        return await self._adelete_bucket_by_id_oapg(
    ...
    def delete_bucket_by_id(
        ...
        return self._delete_bucket_by_id_oapg(
            path_params=args.path,
        )

class DeleteBucketById(BaseApi):
    ...
    async def adelete_bucket_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_bucket_by_id(
            bucket_id=bucket_id,
            **kwargs,
        )
    ...
    def delete_bucket_by_id(
        ...
        raw_response = self.raw.delete_bucket_by_id(
            bucket_id=bucket_id,
        )
