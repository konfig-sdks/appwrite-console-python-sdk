...
class GetBucketRaw(BaseApi):
    ...
    async def aget_bucket(
        ...
        **kwargs,
        ...
        args = self._get_bucket_mapped_args(
            bucket_id=bucket_id,
        )
        return await self._aget_bucket_oapg(
...
class GetBucket(BaseApi):
    ...
    async def aget_bucket(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_bucket(
            bucket_id=bucket_id,
            **kwargs,
        )
        if validate:
    ...
    def get_bucket(
        ...
        raw_response = self.raw.get_bucket(
            bucket_id=bucket_id,
        )
        if validate:
            return BucketPydantic(**raw_response.body)
