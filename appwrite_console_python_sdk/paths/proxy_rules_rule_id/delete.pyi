...
class BaseApi(api_client.Api):
    ...
    def _delete_rule_by_id_mapped_args(
        self,
        rule_id: str,
    ...
    async def _adelete_rule_by_id_oapg(
        self,
...
class DeleteRuleByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_rule_by_id(
        self,
        rule_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_rule_by_id_mapped_args(
            rule_id=rule_id,
        )
        return await self._adelete_rule_by_id_oapg(
    ...
    def delete_rule_by_id(
        ...
        return self._delete_rule_by_id_oapg(
            path_params=args.path,
        )

class DeleteRuleById(BaseApi):
    ...
    async def adelete_rule_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_rule_by_id(
            rule_id=rule_id,
            **kwargs,
        )
    ...
    def delete_rule_by_id(
        ...
        raw_response = self.raw.delete_rule_by_id(
            rule_id=rule_id,
        )
