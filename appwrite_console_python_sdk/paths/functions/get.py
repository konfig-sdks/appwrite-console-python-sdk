...
from appwrite_console_python_sdk.model.function_list import FunctionList as FunctionListSchema

from appwrite_console_python_sdk.type.function_list import FunctionList

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.function_list import FunctionList as FunctionListPydantic
...
SchemaFor200ResponseBodyApplicationJson = FunctionListSchema
...
class ListAll(BaseApi):
    ...
    async def alist_all(
        ...
        **kwargs,
        ...
        if validate:
            return FunctionListPydantic(**raw_response.body)
        return api_client.construct_model_instance(FunctionListPydantic, raw_response.body)
