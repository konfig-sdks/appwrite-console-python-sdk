...
class BaseApi(api_client.Api):
    ...
    def _get_builds_queue_mapped_args(
        self,
    ...
    async def _aget_builds_queue_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/health/queue/builds',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetBuildsQueueRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_builds_queue(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_builds_queue_mapped_args(
            threshold=threshold,
        )
        return await self._aget_builds_queue_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_builds_queue(
        self,
        threshold: typing.Optional[int] = None,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_builds_queue_oapg(
            query_params=args.query,
        )

class GetBuildsQueue(BaseApi):
    ...
    async def aget_builds_queue(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_builds_queue(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_builds_queue(
        ...
        raw_response = self.raw.get_builds_queue(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
