...
from appwrite_console_python_sdk.model.project_list import ProjectList as ProjectListSchema

from appwrite_console_python_sdk.type.project_list import ProjectList

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.project_list import ProjectList as ProjectListPydantic
...
SchemaFor200ResponseBodyApplicationJson = ProjectListSchema
...
class BaseApi(api_client.Api):
    ...
    def _list_projects_mapped_args(
        self,
    ...
    async def _alist_projects_oapg(
        self,
...
class ListProjectsRaw(BaseApi):
    ...
    async def alist_projects(
        ...
        **kwargs,
        ...
        args = self._list_projects_mapped_args(
            queries=queries,
            search=search,
        )
        return await self._alist_projects_oapg(
...
class ListProjects(BaseApi):
    ...
    async def alist_projects(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_projects(
            queries=queries,
            search=search,
            **kwargs,
        )
        if validate:
            return ProjectListPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProjectListPydantic, raw_response.body)
    ...
    def list_projects(
        ...
        raw_response = self.raw.list_projects(
            queries=queries,
            search=search,
        )
        if validate:
