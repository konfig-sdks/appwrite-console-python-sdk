...
class BaseApi(api_client.Api):
    ...
    def _get_image_url_and_crop_mapped_args(
        self,
        url: str,
    ...
    async def _aget_image_url_and_crop_oapg(
        self,
    ...
    def _get_image_url_and_crop_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetImageUrlAndCropRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_image_url_and_crop(
        self,
        url: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        **kwargs,
        ...
        args = self._get_image_url_and_crop_mapped_args(
            url=url,
            width=width,
            height=height,
        )
        return await self._aget_image_url_and_crop_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_image_url_and_crop(
        self,
        url: str,
        width: typing.Optional[int] = None,
        height: typing.Optional[int] = None,
        ...
        return self._get_image_url_and_crop_oapg(
            query_params=args.query,
        )

class GetImageUrlAndCrop(BaseApi):
    ...
    async def aget_image_url_and_crop(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_image_url_and_crop(
            url=url,
            width=width,
            height=height,
            **kwargs,
    ...
    def get_image_url_and_crop(
        ...
        raw_response = self.raw.get_image_url_and_crop(
            url=url,
            width=width,
            height=height,
        )
