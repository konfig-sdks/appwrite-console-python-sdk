...
SchemaFor200ResponseBodyApplicationJson = IndexSchema
...
class BaseApi(api_client.Api):
    ...
    def _get_index_by_id_mapped_args(
        self,
        database_id: str,
        collection_id: str,
        key: str,
    ...
    async def _aget_index_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/databases/{databaseId}/collections/{collectionId}/indexes/{key}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetIndexByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_index_by_id(
        self,
        database_id: str,
        collection_id: str,
        key: str,
        **kwargs,
        ...
        args = self._get_index_by_id_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
        return await self._aget_index_by_id_oapg(
    ...
    def get_index_by_id(
        ...
        return self._get_index_by_id_oapg(
            path_params=args.path,
        )

class GetIndexById(BaseApi):
    ...
    async def aget_index_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_index_by_id(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
            **kwargs,
    ...
    def get_index_by_id(
        ...
        raw_response = self.raw.get_index_by_id(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
