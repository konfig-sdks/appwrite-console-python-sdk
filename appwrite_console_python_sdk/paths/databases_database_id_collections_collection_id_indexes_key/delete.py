...
class BaseApi(api_client.Api):
    ...
    def _delete_index_by_key_mapped_args(
        self,
        database_id: str,
        collection_id: str,
        key: str,
    ...
    async def _adelete_index_by_key_oapg(
        self,
...
class DeleteIndexByKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_index_by_key(
        self,
        database_id: str,
        collection_id: str,
        key: str,
        **kwargs,
        ...
        args = self._delete_index_by_key_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
        return await self._adelete_index_by_key_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def delete_index_by_key(
        self,
        database_id: str,
        collection_id: str,
        key: str,
        ...
        return self._delete_index_by_key_oapg(
            path_params=args.path,
        )

class DeleteIndexByKey(BaseApi):
    ...
    async def adelete_index_by_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_index_by_key(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
            **kwargs,
    ...
    def delete_index_by_key(
        ...
        raw_response = self.raw.delete_index_by_key(
            database_id=database_id,
            collection_id=collection_id,
            key=key,
        )
