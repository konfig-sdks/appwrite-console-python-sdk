...
from appwrite_console_python_sdk.model.log_list import LogList as LogListSchema

from appwrite_console_python_sdk.type.log_list import LogList

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.log_list import LogList as LogListPydantic
...
class BaseApi(api_client.Api):
    ...
    def _list_collection_logs_mapped_args(
        self,
        database_id: str,
        collection_id: str,
    ...
    async def _alist_collection_logs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/databases/{databaseId}/collections/{collectionId}/logs',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _list_collection_logs_oapg(
        self,
            query_params: typing.Optional[dict] = {},
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class ListCollectionLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_collection_logs(
        self,
        database_id: str,
        collection_id: str,
        queries: typing.Optional[typing.List[str]] = None,
        **kwargs,
        ...
        args = self._list_collection_logs_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
        )
        return await self._alist_collection_logs_oapg(
    ...
    def list_collection_logs(
        ...
        return self._list_collection_logs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListCollectionLogs(BaseApi):
    ...
    async def alist_collection_logs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_collection_logs(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
            **kwargs,
    ...
    def list_collection_logs(
        ...
        raw_response = self.raw.list_collection_logs(
            database_id=database_id,
            collection_id=collection_id,
            queries=queries,
        )
