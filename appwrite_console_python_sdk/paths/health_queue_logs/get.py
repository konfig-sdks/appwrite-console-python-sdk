...
class BaseApi(api_client.Api):
    ...
    def _get_queue_logs_mapped_args(
        self,
    ...
    async def _aget_queue_logs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/health/queue/logs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetQueueLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_queue_logs(
        self,
        threshold: typing.Optional[int] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_queue_logs_mapped_args(
            threshold=threshold,
        )
        return await self._aget_queue_logs_oapg(
    ...
    def get_queue_logs(
        ...
        return self._get_queue_logs_oapg(
            query_params=args.query,
        )

class GetQueueLogs(BaseApi):
    ...
    async def aget_queue_logs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_queue_logs(
            threshold=threshold,
            **kwargs,
        )
        if validate:
    ...
    def get_queue_logs(
        ...
        raw_response = self.raw.get_queue_logs(
            threshold=threshold,
        )
        if validate:
            return HealthQueuePydantic(**raw_response.body)
