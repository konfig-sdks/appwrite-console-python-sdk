...
from appwrite_console_python_sdk.model.usage_project import UsageProject as UsageProjectSchema

from appwrite_console_python_sdk.type.usage_project import UsageProject

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.usage_project import UsageProject as UsageProjectPydantic
...
SchemaFor200ResponseBodyApplicationJson = UsageProjectSchema
...
class GetUsageStats(BaseApi):
    ...
    async def aget_usage_stats(
        ...
        **kwargs,
        ...
        if validate:
            return UsageProjectPydantic(**raw_response.body)
        return api_client.construct_model_instance(UsageProjectPydantic, raw_response.body)
