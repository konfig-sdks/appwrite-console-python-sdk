...
class BaseApi(api_client.Api):
    ...
    def _get_download_file_mapped_args(
        self,
        bucket_id: str,
        file_id: str,
    ...
    async def _aget_download_file_oapg(
        self,
...
class GetDownloadFileRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_download_file(
        self,
        bucket_id: str,
        file_id: str,
        **kwargs,
        ...
        args = self._get_download_file_mapped_args(
            bucket_id=bucket_id,
            file_id=file_id,
        )
        return await self._aget_download_file_oapg(
    ...
    def get_download_file(
        ...
        return self._get_download_file_oapg(
            path_params=args.path,
        )

class GetDownloadFile(BaseApi):
    ...
    async def aget_download_file(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_download_file(
            bucket_id=bucket_id,
            file_id=file_id,
            **kwargs,
        )
    ...
    def get_download_file(
        ...
        raw_response = self.raw.get_download_file(
            bucket_id=bucket_id,
            file_id=file_id,
        )
