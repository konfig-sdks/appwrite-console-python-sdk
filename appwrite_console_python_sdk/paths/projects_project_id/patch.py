...
from appwrite_console_python_sdk.model.projects_update_detail_request import ProjectsUpdateDetailRequest as ProjectsUpdateDetailRequestSchema

from appwrite_console_python_sdk.type.project import Project
from appwrite_console_python_sdk.type.projects_update_detail_request import ProjectsUpdateDetailRequest

from ...api_client import Dictionary
from appwrite_console_python_sdk.pydantic.project import Project as ProjectPydantic
from appwrite_console_python_sdk.pydantic.projects_update_detail_request import ProjectsUpdateDetailRequest as ProjectsUpdateDetailRequestPydantic
...
# body param
SchemaForRequestBodyApplicationJson = ProjectsUpdateDetailRequestSchema


request_body_projects_update_detail_request = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_detail_mapped_args(
        self,
        name: str,
        project_id: str,
    ...
    async def _aupdate_detail_oapg(
        self,
        ...
        **kwargs,
        ...
        if body is not schemas.unset:
            serialized_data = request_body_projects_update_detail_request.serialize(body, content_type)
...
class UpdateDetailRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_detail(
        self,
        name: str,
        project_id: str,
        description: typing.Optional[str] = None,
        ...
        **kwargs,
        ...
        args = self._update_detail_mapped_args(
            name=name,
        ...
        return await self._aupdate_detail_oapg(
            body=args.body,
    ...
    def update_detail(
        ...
        return self._update_detail_oapg(
            body=args.body,
            path_params=args.path,
        )

class UpdateDetail(BaseApi):
    ...
    async def aupdate_detail(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_detail(
            name=name,
            project_id=project_id,
            description=description,
            logo=logo,
    ...
    def update_detail(
        ...
        raw_response = self.raw.update_detail(
            name=name,
            project_id=project_id,
            description=description,
            logo=logo,
