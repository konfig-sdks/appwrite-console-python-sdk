...
class BaseApi(api_client.Api):
    ...
    def _list_document_logs_mapped_args(
        self,
        database_id: str,
        collection_id: str,
        document_id: str,
    ...
    async def _alist_document_logs_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/databases/{databaseId}/collections/{collectionId}/documents/{documentId}/logs',
            auth_settings=_auth,
            headers=_headers,
        )
...
class ListDocumentLogsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def alist_document_logs(
        self,
        database_id: str,
        collection_id: str,
        document_id: str,
        ...
        **kwargs,
        ...
        args = self._list_document_logs_mapped_args(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
            queries=queries,
        )
        return await self._alist_document_logs_oapg(
    ...
    def list_document_logs(
        ...
        return self._list_document_logs_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class ListDocumentLogs(BaseApi):
    ...
    async def alist_document_logs(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.alist_document_logs(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
            queries=queries,
    ...
    def list_document_logs(
        ...
        raw_response = self.raw.list_document_logs(
            database_id=database_id,
            collection_id=collection_id,
            document_id=document_id,
            queries=queries,
