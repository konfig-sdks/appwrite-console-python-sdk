...
class BaseApi(api_client.Api):
    ...
    def _get_sms_template_mapped_args(
        self,
        project_id: str,
        type: str,
        locale: str,
    ...
    async def _aget_sms_template_oapg(
        self,
...
class GetSmsTemplateRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sms_template(
        self,
        project_id: str,
        type: str,
        locale: str,
        **kwargs,
        ...
        args = self._get_sms_template_mapped_args(
            project_id=project_id,
            type=type,
            locale=locale,
        )
        return await self._aget_sms_template_oapg(
    ...
    def get_sms_template(
        ...
        return self._get_sms_template_oapg(
            path_params=args.path,
        )

class GetSmsTemplate(BaseApi):
    ...
    async def aget_sms_template(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_sms_template(
            project_id=project_id,
            type=type,
            locale=locale,
            **kwargs,
    ...
    def get_sms_template(
        ...
        raw_response = self.raw.get_sms_template(
            project_id=project_id,
            type=type,
            locale=locale,
        )
