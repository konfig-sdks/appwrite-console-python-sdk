...
class BaseApi(api_client.Api):
    ...
    def _update_webhook_signature_mapped_args(
        self,
        project_id: str,
        webhook_id: str,
    ...
    async def _aupdate_webhook_signature_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/projects/{projectId}/webhooks/{webhookId}/signature',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _update_webhook_signature_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class UpdateWebhookSignatureRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aupdate_webhook_signature(
        self,
        project_id: str,
        webhook_id: str,
        **kwargs,
        ...
        args = self._update_webhook_signature_mapped_args(
            project_id=project_id,
            webhook_id=webhook_id,
        )
        return await self._aupdate_webhook_signature_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def update_webhook_signature(
        self,
        project_id: str,
        webhook_id: str,
    ) -> typing.Union[
        ...
        return self._update_webhook_signature_oapg(
            path_params=args.path,
        )

class UpdateWebhookSignature(BaseApi):
    ...
    async def aupdate_webhook_signature(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aupdate_webhook_signature(
            project_id=project_id,
            webhook_id=webhook_id,
            **kwargs,
        )
    ...
    def update_webhook_signature(
        ...
        raw_response = self.raw.update_webhook_signature(
            project_id=project_id,
            webhook_id=webhook_id,
        )
        if validate:
