...
class BaseApi(api_client.Api):
    ...
    def _delete_function_by_id_mapped_args(
        self,
        function_id: str,
    ...
    async def _adelete_function_by_id_oapg(
        self,
    ...
    def _delete_function_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DeleteFunctionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_function_by_id(
        self,
        function_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_function_by_id_mapped_args(
            function_id=function_id,
        )
        return await self._adelete_function_by_id_oapg(
    ...
    def delete_function_by_id(
        ...
        return self._delete_function_by_id_oapg(
            path_params=args.path,
        )

class DeleteFunctionById(BaseApi):
    ...
    async def adelete_function_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_function_by_id(
            function_id=function_id,
            **kwargs,
        )
    ...
    def delete_function_by_id(
        ...
        raw_response = self.raw.delete_function_by_id(
            function_id=function_id,
        )
