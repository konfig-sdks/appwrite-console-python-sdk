...
class GetKeyRaw(BaseApi):
    ...
    async def aget_key(
        ...
        **kwargs,
        ...
        args = self._get_key_mapped_args(
            project_id=project_id,
            key_id=key_id,
        )
        return await self._aget_key_oapg(
...
class GetKey(BaseApi):
    ...
    async def aget_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_key(
            project_id=project_id,
            key_id=key_id,
            **kwargs,
        )
