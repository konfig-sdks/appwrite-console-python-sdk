...
class DeleteKeyRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_key(
        self,
        project_id: str,
        key_id: str,
        **kwargs,
        ...
        args = self._delete_key_mapped_args(
            project_id=project_id,
            key_id=key_id,
        )
        return await self._adelete_key_oapg(
...
class DeleteKey(BaseApi):
    ...
    async def adelete_key(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_key(
            project_id=project_id,
            key_id=key_id,
            **kwargs,
        )
    ...
    def delete_key(
        ...
        raw_response = self.raw.delete_key(
            project_id=project_id,
            key_id=key_id,
        )
