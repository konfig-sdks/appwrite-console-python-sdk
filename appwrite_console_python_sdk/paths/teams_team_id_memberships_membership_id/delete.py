...
class BaseApi(api_client.Api):
    ...
    def _remove_membership_mapped_args(
        self,
        team_id: str,
        membership_id: str,
    ...
    async def _aremove_membership_oapg(
        self,
...
class RemoveMembershipRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aremove_membership(
        self,
        team_id: str,
        membership_id: str,
        **kwargs,
        ...
        args = self._remove_membership_mapped_args(
            team_id=team_id,
            membership_id=membership_id,
        )
        return await self._aremove_membership_oapg(
    ...
    def remove_membership(
        ...
        return self._remove_membership_oapg(
            path_params=args.path,
        )

class RemoveMembership(BaseApi):
    ...
    async def aremove_membership(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aremove_membership(
            team_id=team_id,
            membership_id=membership_id,
            **kwargs,
        )
    ...
    def remove_membership(
        ...
        raw_response = self.raw.remove_membership(
            team_id=team_id,
            membership_id=membership_id,
        )
