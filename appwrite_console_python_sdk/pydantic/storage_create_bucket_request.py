...
from appwrite_console_python_sdk.pydantic.storage_create_bucket_request_allowed_file_extensions import StorageCreateBucketRequestAllowedFileExtensions
from appwrite_console_python_sdk.pydantic.storage_create_bucket_request_permissions import StorageCreateBucketRequestPermissions

class StorageCreateBucketRequest(BaseModel):
    ...
    permissions: typing.Optional[StorageCreateBucketRequestPermissions] = Field(None, alias='permissions')
    ...
    allowed_file_extensions: typing.Optional[StorageCreateBucketRequestAllowedFileExtensions] = Field(None, alias='allowedFileExtensions')
