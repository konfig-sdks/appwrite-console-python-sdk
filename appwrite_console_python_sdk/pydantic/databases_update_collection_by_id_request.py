...
from appwrite_console_python_sdk.pydantic.databases_update_collection_by_id_request_permissions import DatabasesUpdateCollectionByIdRequestPermissions
