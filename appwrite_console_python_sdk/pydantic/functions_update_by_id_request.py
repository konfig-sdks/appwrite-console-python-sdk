...
from appwrite_console_python_sdk.pydantic.functions_update_by_id_request_events import FunctionsUpdateByIdRequestEvents
from appwrite_console_python_sdk.pydantic.functions_update_by_id_request_execute import FunctionsUpdateByIdRequestExecute
