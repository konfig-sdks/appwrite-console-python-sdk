...
from appwrite_console_python_sdk.pydantic.bucket_allowed_file_extensions import BucketAllowedFileExtensions
from appwrite_console_python_sdk.pydantic.bucketpermissions import Bucketpermissions
