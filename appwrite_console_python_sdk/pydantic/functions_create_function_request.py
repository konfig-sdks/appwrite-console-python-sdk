...
from appwrite_console_python_sdk.pydantic.functions_create_function_request_events import FunctionsCreateFunctionRequestEvents
from appwrite_console_python_sdk.pydantic.functions_create_function_request_execute import FunctionsCreateFunctionRequestExecute

class FunctionsCreateFunctionRequest(BaseModel):
    ...
    execute: typing.Optional[FunctionsCreateFunctionRequestExecute] = Field(None, alias='execute')

    events: typing.Optional[FunctionsCreateFunctionRequestEvents] = Field(None, alias='events')
