...
from appwrite_console_python_sdk.pydantic.messaging_update_push_message_request_targets import MessagingUpdatePushMessageRequestTargets
from appwrite_console_python_sdk.pydantic.messaging_update_push_message_request_topics import MessagingUpdatePushMessageRequestTopics
from appwrite_console_python_sdk.pydantic.messaging_update_push_message_request_users import MessagingUpdatePushMessageRequestUsers

class MessagingUpdatePushMessageRequest(BaseModel):
    # Title for push notification.
    title: typing.Optional[str] = Field(None, alias='title')

    topics: typing.Optional[MessagingUpdatePushMessageRequestTopics] = Field(None, alias='topics')

    users: typing.Optional[MessagingUpdatePushMessageRequestUsers] = Field(None, alias='users')

    targets: typing.Optional[MessagingUpdatePushMessageRequestTargets] = Field(None, alias='targets')
