...
from appwrite_console_python_sdk.paths.projects_project_id_auth_password_history import patch
from appwrite_console_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestProjectsProjectIdAuthPasswordHistory(ApiTestMixin, unittest.TestCase):
    """
    ProjectsProjectIdAuthPasswordHistory unit test stubs
